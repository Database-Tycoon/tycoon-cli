...
_In-flight cycle. Four tracks: dependency hygiene (shipped — this section), first-class dbt profile handling ([#27][], landed), OSI semantic-layer scaffolding ([#28][], design resolved), and Fivetran metadata read-out ([#26][], pulled in from v0.2.x). See [`docs/releases/v0.1.6.md`](docs/releases/v0.1.6.md) for the running narrative._
