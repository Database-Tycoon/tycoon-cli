...
Four themes in this release: **MotherDuck alignment**,
**`tycoon register warehouse`**, a **network-gated e2e test suite**, and a
**Nao/ask cleanup pass** — finishing out the register family, the
warehouse-alignment story from v0.1.1, and fixing a cluster of papercuts
around `tycoon ask` that surfaced during the MotherDuck + Nao + LM Studio
dogfood walkthrough.
